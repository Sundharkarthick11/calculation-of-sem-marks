function calcInternalMark() {
  ...
  function adjustTableBoxHeight() {
    var tableBox = document.querySelector('.table-box');
    var tableHeight = document.getElementById('markSheetTable').offsetHeight;
    tableBox.style.height = tableHeight + 'px';
}

// Call the adjustTableBoxHeight function after adding or deleting rows
document.getElementById("addSubject").addEventListener("click", function(event) {
    addFun(event);
    adjustTableBoxHeight();
});
...
/*
function printTable(){
    var table=document.getElementById("markSheetTable");
    var printWindow=window.open('',"blank");
